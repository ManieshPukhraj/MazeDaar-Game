...
bg = pygame.transform.scale(pygame.image.load('D:\Mazedaar-Game-main 3\Mazedaar-Game-main\grass.png'),(710,710))
bg_2=pygame.image.load("D:\Mazedaar-Game-main 3\Mazedaar-Game-main\main_bg.png")
QB_images_path = []
for image in os.listdir("D:\Mazedaar-Game-main 3\Mazedaar-Game-main\QB") :
...
class Block(pg.sprite.Sprite) :
    def __init__(self,x,y) :
        ...
        self.image = pygame.transform.scale(pygame.image.load('Mazedaar-Game-main\wall.png'),(10,10))
...
class CheckpointBlock(pg.sprite.Sprite) :
    def __init__(self,x,y) :
        super().__init__()
        self.image=pygame.transform.scale(pygame.image.load("Mazedaar-Game-main\checkpoint.png"), (tile_size*4, tile_size*4))
        self.rect = self.image.get_rect()
        self.x = x ; self.y = y
        self.rect.x = x*tile_size ; self.rect.y = y*tile_size
    def update(self) :
...
class Door(pg.sprite.Sprite) :
    def __init__(self,x,y) :
        super().__init__()
        self.image=pygame.transform.scale(pygame.image.load("D:\Mazedaar-Game-main 3\Mazedaar-Game-main\door.png"), (tile_size*6, tile_size*6))
        self.rect = self.image.get_rect()
        self.x = x ; self.y = y
        self.rect.x = x*tile_size ; self.rect.y = y*tile_size
        self.counter = 0
    ...
    def update(self) :
        ...
        if self.rect.colliderect(player.rect) :
            ...
            font = pygame.font.Font('Mazedaar-Game-main\font.ttf', 16)
            ...
            if ((self.counter//20)%2 == 0):
                self.pick=pygame.transform.scale(pygame.image.load('Mazedaar-Game-main\key.png'),(tile_size*10,tile_size*10))
...
class Player(pg.sprite.Sprite) :
    def __init__(self,x,y) :
        ...
        self.dim = (40,40)
        self.image = pygame.transform.scale(pygame.image.load('D:\Mazedaar-Game-main 3\Mazedaar-Game-main\sprites\l3.png'),self.dim)
        self.rect = self.image.get_rect()
        ...
        for i in range(4):
            self.up.append(pygame.transform.scale(pygame.image.load(f'Mazedaar-Game-main\sprites/u{i}.png'),self.dim))
            self.down.append(pygame.transform.scale(pygame.image.load(f'Mazedaar-Game-main\sprites/d{i}.png'),self.dim))
            self.left.append(pygame.transform.scale(pygame.image.load(f'Mazedaar-Game-main\sprites/l{i}.png'),self.dim))
            self.right.append(pygame.transform.scale(pygame.image.load(f'Mazedaar-Game-main\sprites/r{i}.png'),self.dim)) 
...
def custom_draw() :
        ...
        font = pygame.font.Font('Mazedaar-Game-main\font.ttf', 32)
...
def store_levels() :
    #level1.dat
    f = open(f'Mazedaar-Game-main\level{lev}.dat','ab')
    L = []
    for block in block_grp :
        if not isinstance(block,Player) :
            x,y = block.getxy()
...
def load_levels() :
    ...
    f = open(f'Mazedaar-Game-main\level{lev}.dat','rb')
    #n = 3
    #for i in range(n) :
    L = pickle.load(f)
